    ...
    <div className="flex justify-center">
      <div className="mt-10 left-0 right-0 py-[2%] w-[80%] flex justify-between text-center flex-col items-center">
          <div className="p-5 text-white relative flex justify-center flex-col">
            ...
            <p className="text-black">After returning to school from the pandemic and remote learning, we noticed a considerable amount of students who lacked laptops lag behind in their studying because they didn't have 
